...
import {
    ...
    PlusIcon,
    ArchiveIcon,
    // XIcon, // XIcon was imported but not used in the provided code, so commented unless needed elsewhere
} from './icons';

// onOpenMovePartialModal is part of props
                    ...
                    {safeBatch.stage === 'incubation' && ( /* */
                        <>
                            <button
                                ...
                                disabled={!safeBatch.colonisationCompleteDate} // This button still requires full colonisation
                                title={!safeBatch.colonisationCompleteDate ? "Set colonisation date first for the whole batch" : "Move ALL to Grow Room"} // Updated title
                            >
                            ...
                            {onOpenMovePartialModal && (
                                <button
                                    ...
                                    // REMOVED: disabled={!safeBatch.colonisationCompleteDate}
                                    title={"Move PARTIAL to Grow Room (some units colonised)"} // Updated title
                                >
